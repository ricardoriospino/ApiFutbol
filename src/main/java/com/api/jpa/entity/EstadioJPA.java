...
public class EstadioJPA implements Serializable {
	...
	public EstadioJPA(int idEstadio, String nombreEstadio, int capacidad, String ubicacion) {
		super();
	...
	public String toString() {
		return "EstadioJPA [idEstadio=" + idEstadio + ", nombreEstadio=" + nombreEstadio + ", capacidad=" + capacidad
				+ ", ubicacion=" + ubicacion + "]";
	}
